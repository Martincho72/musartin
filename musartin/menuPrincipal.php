...
<head>
    ...
    <style>
        ...
        .btn-primary {
            background-color: #6bbf7e; /* Verde suave */
        }

        .btn-primary:hover {
            background-color: #5aa46d; /* Verde suave más oscuro */
        }
        ...
        .btn-orange:hover {
            background-color: #cc8400; /* Naranja más oscuro */
        }
        ...
        .btn-blue:hover {
            background-color: #0056b3; /* Azul primario más oscuro */
        }
